    ...
    render() {
        ...
        return (
            <View style={{ height: 60 }}>
                <View style={[styles.gradient, { paddingTop: 5, backgroundColor: 'gray'}]}>
                    <View style={styles.headerView}>
                        {title === "Messages" ?
                            ...
                            <View style={{ alignItems: 'flex-start' }}>
                                <TouchableOpacity style={styles.iconView} onPress={() => { navigation.goBack(null) }}>
                                    ...
                                    <Image  resizeMode='contain' style={{width:40,height:35,borderRadius:20}} source={require('./assests/arow.png')}/>
                                </TouchableOpacity>
                            </View>
                        }
                        ...
                        {title === "Messages" ? <View style={{ width: '10%', alignItems: 'flex-end', marginLeft: 10 }}>
                            <TouchableOpacity style={styles.iconView} onPress={() => { onPress() }}>
                                ...
                                <Image resizeMode='contain'  style={{width:30,height:25}} source={require('./assests/lgout.jpg')}/>
                            </TouchableOpacity>
                        </View> : null}
                    </View>
                </View>
